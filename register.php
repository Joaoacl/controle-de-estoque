...
<div class="register-box">
  <div class="register-logo">
    <a href="views/login.php"><b>CB</b> Alimentos</a>
  </div>

  <div class="register-box-body">
    <h4 class="login-box-msg">Registrar-se</h4>
    ...
    <p>Já possui uma conta? <a href="login.php" class="text-center">Acesse aqui</a></p>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
